...
raylib:
	...
	@cd $(RAYLIB_DIR)/src && $(MAKE) PLATFORM=PLATFORM_DESKTOP RAYLIB_LIBTYPE=STATIC GRAPHICS=GRAPHICS_API_OPENGL_33 USE_EXTERNAL_GLFW=FALSE RAYLIB_BUILD_MODE=RELEASE RAYLIB_RELEASE_PATH="." CFLAGS="-w -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GNU_SOURCE" -B
